...
#with col3:
    ...
    unsafe_allow_html=True
        ...
        st.markdown(f"<span style='color:#fdf798; font-size:17px;'>ဆောင်ရန်၊ ရှောင်ရန် :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style='color:white;font-size:15px;'>{json_data['instruction']}</span>", unsafe_allow_html=True)
